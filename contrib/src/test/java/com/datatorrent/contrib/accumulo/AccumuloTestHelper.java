...
public class AccumuloTestHelper {
		...
		try {
		 ...
		 try {
	      for (int i=0; i < 500; ++i) {
	        ...
	        for (int j=0; j < 500; ++j) {
	          mutation.put(colfam0_bytes, Bytes.toBytes("col" + "-" +  j ),System.currentTimeMillis(), Bytes.toBytes("val" + "-" + i + "-" + j));
	        }
	...
	public static AccumuloTuple findTuple(List<AccumuloTuple> tuples, String row, String colFamily, String colName) {
